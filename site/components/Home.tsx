    ...
    <div className="px-8 pt-32 pb-32 sm:px-6 lg:px-8 text-white bg-gradient-to-b from-blackish to-color2 animate-gradient-x bg-repeat flex justify-content">
      <div className="lg:max-w-9xl flex flex-col items-center lg:gap-x-4 mx-auto">
        ...
        <div className="flex flex-col justify-center items-center sm:flex-row gap-4 my-6 text-md sm:text-xl w-full">
          ...
          <button className="focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50 text-white font-semibold h-12 p-8 rounded-lg w-full flex items-center justify-center gap-2 sm:w-auto bg-gray-800 hover:bg-gray-700">
            <svg
              stroke="currentColor"
              fill="currentColor"
              strokeWidth="0"
